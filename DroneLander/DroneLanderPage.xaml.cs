...
{
	public partial class DroneLanderPage : ContentPage
	{
		public DroneLanderPage()
		{
			InitializeComponent();
		}
		...
		protected override void OnAppearing()
		{
			...
			MessagingCenter.Subscribe<DroneLanderPage, LandingResultType>(this, "ActivityUpdate", (sender, arg) =>
			{
		...
		{
			base.OnDisappearing();
			MessagingCenter.Unsubscribe<DroneLanderPage, LandingResultType>(this, "ActivityUpdate");
		}
	}
}